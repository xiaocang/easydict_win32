...
static PROPERTIES: &[PropertyDef] = &[
    ...
    PropertyDef { name: "Height", value_type: ValueType::GridLength, applies: Applies::Only(ROW), invalidation: Invalidation::MEASURE, mutable: false },
    PropertyDef { name: "Width", value_type: ValueType::GridLength, applies: Applies::Only(COLUMN), invalidation: Invalidation::MEASURE, mutable: false },

    PropertyDef { name: "Width", value_type: ValueType::Length, applies: Applies::Layout, invalidation: Invalidation::MEASURE_PAINT, mutable: false },
    PropertyDef { name: "Height", value_type: ValueType::Length, applies: Applies::Layout, invalidation: Invalidation::MEASURE_PAINT, mutable: false },
    PropertyDef { name: "MinWidth", value_type: ValueType::Length, applies: Applies::Layout, invalidation: Invalidation::MEASURE_PAINT, mutable: false },
    PropertyDef { name: "MinHeight", value_type: ValueType::Length, applies: Applies::Layout, invalidation: Invalidation::MEASURE_PAINT, mutable: false },
    PropertyDef { name: "MaxWidth", value_type: ValueType::Length, applies: Applies::Layout, invalidation: Invalidation::MEASURE_PAINT, mutable: false },
    PropertyDef { name: "MaxHeight", value_type: ValueType::Length, applies: Applies::Layout, invalidation: Invalidation::MEASURE_PAINT, mutable: false },
    PropertyDef { name: "Margin", value_type: ValueType::Thickness, applies: Applies::Layout, invalidation: Invalidation::MEASURE_PAINT, mutable: false },
    PropertyDef { name: "Opacity", value_type: ValueType::Double, applies: Applies::Layout, invalidation: Invalidation::PAINT, mutable: true },
    PropertyDef { name: "Visibility", value_type: ValueType::Enumeration(EnumKind::Visibility), applies: Applies::Layout, invalidation: Invalidation::MEASURE_PAINT_SEMANTICS, mutable: true },
    PropertyDef { name: "HorizontalAlignment", value_type: ValueType::Enumeration(EnumKind::HorizontalAlignment), applies: Applies::Layout, invalidation: Invalidation::ARRANGE_PAINT, mutable: false },
    PropertyDef { name: "VerticalAlignment", value_type: ValueType::Enumeration(EnumKind::VerticalAlignment), applies: Applies::Layout, invalidation: Invalidation::ARRANGE_PAINT, mutable: false },

    PropertyDef { name: "Padding", value_type: ValueType::Thickness, applies: Applies::Only(PADDABLE), invalidation: Invalidation::MEASURE_PAINT, mutable: false },
    PropertyDef { name: "Background", value_type: ValueType::Brush, applies: Applies::Only(PANELS), invalidation: Invalidation::PAINT, mutable: true },

    PropertyDef { name: "BorderBrush", value_type: ValueType::Brush, applies: Applies::Only(BORDER), invalidation: Invalidation::PAINT, mutable: false },
    PropertyDef { name: "BorderThickness", value_type: ValueType::Thickness, applies: Applies::Only(BORDER), invalidation: Invalidation::MEASURE_PAINT, mutable: false },
    PropertyDef { name: "CornerRadius", value_type: ValueType::CornerRadius, applies: Applies::Only(BORDER), invalidation: Invalidation::PAINT, mutable: false },

    PropertyDef { name: "Spacing", value_type: ValueType::Double, applies: Applies::Only(STACK), invalidation: Invalidation::MEASURE_PAINT, mutable: false },
    PropertyDef { name: "Orientation", value_type: ValueType::Enumeration(EnumKind::Orientation), applies: Applies::Only(STACK), invalidation: Invalidation::MEASURE_PAINT, mutable: false },

    PropertyDef { name: "Text", value_type: ValueType::Str, applies: Applies::Only(TEXT), invalidation: Invalidation::MEASURE_PAINT, mutable: true },
    PropertyDef { name: "FontSize", value_type: ValueType::Double, applies: Applies::Only(TEXT), invalidation: Invalidation::MEASURE_PAINT, mutable: true },
    PropertyDef { name: "FontWeight", value_type: ValueType::Enumeration(EnumKind::FontWeight), applies: Applies::Only(TEXT), invalidation: Invalidation::MEASURE_PAINT, mutable: false },
    PropertyDef { name: "Foreground", value_type: ValueType::Brush, applies: Applies::Only(TEXT), invalidation: Invalidation::PAINT, mutable: true },
    PropertyDef { name: "TextWrapping", value_type: ValueType::Enumeration(EnumKind::TextWrapping), applies: Applies::Only(TEXT), invalidation: Invalidation::MEASURE_PAINT, mutable: false },
    PropertyDef { name: "TextTrimming", value_type: ValueType::Enumeration(EnumKind::TextTrimming), applies: Applies::Only(TEXT), invalidation: Invalidation::MEASURE_PAINT, mutable: false },
    PropertyDef { name: "IsTextSelectionEnabled", value_type: ValueType::Bool, applies: Applies::Only(TEXT), invalidation: Invalidation::SEMANTICS, mutable: false },
];
...
static ATTACHED_PROPERTIES: &[AttachedPropertyDef] = &[
    AttachedPropertyDef { owner: "Grid", name: "Row", value_type: ValueType::Int, parent: ControlKind::Grid, invalidation: Invalidation::MEASURE_ARRANGE_PAINT },
    AttachedPropertyDef { owner: "Grid", name: "Column", value_type: ValueType::Int, parent: ControlKind::Grid, invalidation: Invalidation::MEASURE_ARRANGE_PAINT },
    AttachedPropertyDef { owner: "Grid", name: "RowSpan", value_type: ValueType::Int, parent: ControlKind::Grid, invalidation: Invalidation::MEASURE_ARRANGE_PAINT },
    AttachedPropertyDef { owner: "Grid", name: "ColumnSpan", value_type: ValueType::Int, parent: ControlKind::Grid, invalidation: Invalidation::MEASURE_ARRANGE_PAINT },
];
