...
internal static class LongDocumentCliCommand
{
    ...
    [
        ...
        new("KIMI_API_KEY", nameof(SettingsService.KimiApiKey)),
        new("MOONSHOT_API_KEY", nameof(SettingsService.KimiApiKey)),
        new("KIMI_MODEL", nameof(SettingsService.KimiModel)),
        new("OPENROUTER_API_KEY", nameof(SettingsService.OpenRouterApiKey)),
        new("OPENROUTER_MODEL", nameof(SettingsService.OpenRouterModel)),
        new("ORCAROUTER_API_KEY", nameof(SettingsService.OrcaRouterApiKey)),
        new("ORCAROUTER_MODEL", nameof(SettingsService.OrcaRouterModel)),
