...
internal static class Program
{
    ...
    public static async Task<int> Main(string[] args)
    {
        ...
        dispatcher.Register(LocalAiMethods.TranslateStream,
            new TranslateStreamHandler(state, writer, dispatcher.LookupRequestId).HandleAsync);
        dispatcher.Register(LocalAiMethods.GrammarStream,
            new GrammarStreamHandler(state, writer, dispatcher.LookupRequestId).HandleAsync);
