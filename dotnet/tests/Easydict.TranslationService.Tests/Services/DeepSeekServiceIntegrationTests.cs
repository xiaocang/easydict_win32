...
/// <summary>
/// Integration tests for DeepSeekService using real API calls.
...
public class DeepSeekServiceIntegrationTests : IDisposable
{
    ...
    public DeepSeekServiceIntegrationTests()
    {
    ...
    {
        Skip.If(string.IsNullOrEmpty(_apiKey), "DEEPSEEK_API_KEY not set");
