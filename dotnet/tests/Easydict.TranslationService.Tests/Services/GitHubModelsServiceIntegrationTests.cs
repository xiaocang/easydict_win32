...
/// <summary>
/// Integration tests for GitHubModelsService using real API calls.
...
public class GitHubModelsServiceIntegrationTests : IDisposable
{
    ...
    public GitHubModelsServiceIntegrationTests()
    {
        _apiKey = Environment.GetEnvironmentVariable("GITHUB_MODELS_API_KEY");
    ...
    {
        Skip.If(string.IsNullOrEmpty(_apiKey), "GITHUB_MODELS_API_KEY not set");
