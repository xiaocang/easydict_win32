...
/// <summary>
/// Integration tests for KimiService using real API calls.
/// Requires KIMI_API_KEY environment variable to be set.
/// </summary>
[Trait("Category", "Integration")]
[Trait("Service", "kimi")]
public class KimiServiceIntegrationTests : IDisposable
{
    private readonly HttpClient _httpClient;
    private readonly KimiService _service;
    private readonly string? _apiKey;

    public KimiServiceIntegrationTests()
    {
        _apiKey = Environment.GetEnvironmentVariable("KIMI_API_KEY");
    ...
    {
        Skip.If(string.IsNullOrEmpty(_apiKey), "KIMI_API_KEY not set");
