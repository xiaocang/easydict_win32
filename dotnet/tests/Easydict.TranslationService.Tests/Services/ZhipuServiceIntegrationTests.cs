...
/// <summary>
/// Integration tests for ZhipuService using real API calls.
...
public class ZhipuServiceIntegrationTests : IDisposable
{
    ...
    public ZhipuServiceIntegrationTests()
    {
        _apiKey = Environment.GetEnvironmentVariable("ZHIPU_API_KEY");
    ...
    {
        Skip.If(string.IsNullOrEmpty(_apiKey), "ZHIPU_API_KEY not set");
