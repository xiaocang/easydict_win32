...
public sealed class WorkerPackagingTests
{
    ...
    public void RustHelperPackaging_PublishesBridgeRegistrarAndCliBesideAppExecutable()
    {
        ...
        workflow.Should().Contain("Reject Rust-only profile for dotnet/MSIX artifacts");
        ...
        arm64SmokeWorkflow.Should().Contain("Reject Rust-only profile for dotnet/MSIX smoke");
