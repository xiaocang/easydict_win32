...
impl<Message> View<Message> {
    ...
    pub fn tooltip(mut self, tooltip: impl Into<String>) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["tooltip"]);
    ...
    #[track_caller]
    pub fn text_id(mut self, id: impl Into<String>) -> Self {
        if let ViewToken::Text(token) = &mut self.token {
            token.id = Some(id.into());
        }
        #[cfg(feature = "parity-diagnostics")]
    ...
    #[track_caller]
    pub fn text_font_size(mut self, font_size: u16) -> Self {
        if let ViewToken::Text(token) = &mut self.token {
            token.font_size = Some(font_size);
        }
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set("font_size");
        self
    }

    #[track_caller]
    pub fn text_size(mut self, width: Length, height: Length) -> Self {
        if let ViewToken::Text(token) = &mut self.token {
            token.width = Some(width);
            token.height = Some(height);
        }
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["width", "height"]);
        self
    }

    #[track_caller]
    pub fn text_wrapping(mut self, wrapping: TextWrapping) -> Self {
        if let ViewToken::Text(token) = &mut self.token {
            token.wrapping = wrapping;
        }
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set("wrapping");
        self
    }
}
...
pub struct ButtonToken<Message> {
    ...
    pub kind: ButtonKind,
    pub icon: Option<IconToken>,
    pub trailing_icon: Option<IconToken>,
...
impl<Message> PageBuilder<Message> {
    ...
    pub fn content(mut self, content: impl IntoView<Message>) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["content"]);
    ...
    pub fn command(mut self, command: CommandToken<Message>) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["commands"]);
...
impl<Message> IntoView<Message> for PageBuilder<Message> {
    #[track_caller]
    fn into_view(self) -> View<Message> {
        let token = ViewToken::Page(PageToken {
            id: self.id,
            title: self.title,
...
impl<Message> TitleBarBuilder<Message> {
    ...
    pub fn subtitle(mut self, subtitle: impl Into<String>) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["subtitle"]);
    ...
    pub fn caption_controls(mut self, visible: bool) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["caption_controls"]);
    ...
    pub fn on_minimize(mut self, message: Message) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["minimize"]);
    ...
    pub fn on_toggle_maximize(mut self, message: Message) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["toggle_maximize"]);
    ...
    pub fn on_close(mut self, message: Message) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["close"]);
...
impl<Message> IntoView<Message> for TitleBarBuilder<Message> {
    #[track_caller]
    fn into_view(self) -> View<Message> {
        let token = ViewToken::TitleBar(TitleBarToken {
            id: self.id,
            title: self.title,
...
impl<Message> RichTextBuilder<Message> {
    ...
    pub fn style(mut self, style: TextStyle) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["style"]);
        self.style = style;
        self
    }
    ...
    pub fn wrapping(mut self, wrapping: TextWrapping) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["wrapping"]);
    ...
    pub fn on_link(
        ...
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["on_link"]);
...
impl<Message> IntoView<Message> for RichTextBuilder<Message> {
    ...
    fn into_view(self) -> View<Message> {
        view_from_builder!(
            self,
            ViewToken::RichText(RichTextToken {
                id: self.id,
                runs: self.runs,
                style: self.style,
...
impl<Message> ToggleButtonBuilder<Message> {
    ...
    pub fn enabled(mut self, enabled: bool) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["state"]);
    ...
    pub fn on_toggle(
        ...
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["action"]);
...
impl<Message> IntoView<Message> for ToggleButtonBuilder<Message> {
    ...
    fn into_view(self) -> View<Message> {
        view_from_builder!(
            self,
            ViewToken::ToggleButton(ToggleButtonToken {
                id: self.id,
                label: self.label,
                icon: self.icon,
...
impl<Message> SplitButtonBuilder<Message> {
    ...
    pub fn items(mut self, items: impl IntoIterator<Item = FlyoutMenuItem>) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["items"]);
    ...
    pub fn on_press(mut self, message: Message) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["primary"]);
    ...
    pub fn on_select(
        ...
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["select"]);
...
impl<Message> IntoView<Message> for SplitButtonBuilder<Message> {
    ...
    fn into_view(self) -> View<Message> {
        view_from_builder!(
            self,
            ViewToken::SplitButton(SplitButtonToken {
                id: self.id,
                label: self.label,
                icon: self.icon,
                items: self.items,
...
impl<Message> BorderBuilder<Message> {
    ...
    pub fn corner_radius(mut self, radius: u16) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["corner_radius"]);
    ...
    pub fn stroke_width(mut self, width: u16) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["stroke_width"]);
    ...
    pub fn filled(mut self, filled: bool) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["filled"]);
        self.filled = filled;
        self
    }
    ...
    pub fn padding(mut self, padding: Edges) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["padding"]);
    ...
    pub fn width(mut self, width: Length) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["width"]);
        self.width = width;
        self
    }
    ...
    pub fn height(mut self, height: Length) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["height"]);
        self.height = height;
        self
    }
...
impl<Message> ViewboxBuilder<Message> {
    ...
    pub fn stretch(mut self, stretch: ImageStretch) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["stretch"]);
...
impl<Message> IntoView<Message> for ViewboxBuilder<Message> {
    ...
    fn into_view(self) -> View<Message> {
        view_from_builder!(
            self,
            ViewToken::Viewbox(ViewboxToken {
                id: self.id,
                content: self.content,
...
impl<Message> TabViewBuilder<Message> {
    ...
    pub fn selected(mut self, id: impl Into<String>) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["selected"]);
    ...
    pub fn on_close(mut self, map: impl Fn(String) -> Message + Send + Sync + 'static) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["close_action"]);
...
impl<Message> IntoView<Message> for TabViewBuilder<Message> {
    ...
    fn into_view(self) -> View<Message> {
        view_from_builder!(
            self,
            ViewToken::TabView(TabViewToken {
                id: self.id,
                tabs: self.tabs,
...
impl<Message> TreeViewBuilder<Message> {
    ...
    pub fn on_toggle(mut self, map: impl Fn(String) -> Message + Send + Sync + 'static) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["toggle_action"]);
...
impl<Message> IntoView<Message> for TreeViewBuilder<Message> {
    ...
    fn into_view(self) -> View<Message> {
        view_from_builder!(
            self,
            ViewToken::TreeView(TreeViewToken {
                id: self.id,
                roots: self.roots,
                selected: self.selected,
                action: self.action,
...
pub struct ButtonBuilder<Message> {
    ...
    icon: Option<IconToken>,
    tooltip: Option<String>,
    trailing_icon: Option<IconToken>,
    width: Option<Length>,
...
impl<Message> ButtonBuilder<Message> {
    ...
    #[track_caller]
    pub fn trailing_icon(mut self, icon: IconToken) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["trailing_icon"]);
    ...
    pub fn text_style(mut self, style: TextStyle) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["text_style"]);
    ...
    pub fn font_size(mut self, size: u16) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["font_size"]);
    ...
    pub fn margin(mut self, value: Edges) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["margin"]);
        self.margin = value;
        self
    }
...
impl<Message> IntoView<Message> for ButtonBuilder<Message> {
    #[track_caller]
    fn into_view(self) -> View<Message> {
        let token = ViewToken::Button(ButtonToken {
            id: self.id,
            label: self.label,
            kind: self.kind,
            icon: self.icon,
...
impl<Message> FlyoutButtonBuilder<Message> {
    ...
    pub fn placement(mut self, placement: FlyoutPlacement) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["placement"]);
    ...
    pub fn min_width(mut self, value: u16) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["min_width"]);
    ...
    pub fn min_height(mut self, value: u16) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["min_height"]);
    ...
    pub fn border_width(mut self, value: u16) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["border_width"]);
    ...
    pub fn radius(mut self, value: u16) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["radius"]);
    ...
    pub fn align_y(mut self, align_y: Alignment) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["align_y"]);
...
impl<Message> IntoView<Message> for FlyoutButtonBuilder<Message> {
    ...
    fn into_view(self) -> View<Message> {
        view_from_builder!(
            self,
            ViewToken::FlyoutButton(FlyoutButtonToken {
                id: self.id,
                label: self.label,
                icon: self.icon,
                tooltip: self.tooltip,
...
impl<Message> StatusBadgeBuilder<Message> {
    ...
    pub fn count(mut self, value: u32) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["count"]);
...
impl<Message> IntoView<Message> for StatusBadgeBuilder<Message> {
    ...
    fn into_view(self) -> View<Message> {
        view_from_builder!(
            self,
            ViewToken::StatusBadge(StatusBadgeToken {
                id: self.id,
                label: self.label,
                kind: self.kind,
                count: self.count,
...
impl<Message> InfoBarBuilder<Message> {
    ...
    pub fn message(mut self, message: impl Into<String>) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["message"]);
...
impl<Message> IntoView<Message> for InfoBarBuilder<Message> {
    ...
    fn into_view(self) -> View<Message> {
        view_from_builder!(
            self,
            ViewToken::InfoBar(InfoBarToken {
                id: self.id,
                title: self.title,
...
impl<Message> ProgressRingBuilder<Message> {
    ...
    pub fn active(mut self, active: bool) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["active"]);
        self.active = active;
        self
    }
    ...
    pub fn label(mut self, label: impl Into<String>) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["label"]);
...
impl<Message> IntoView<Message> for ProgressRingBuilder<Message> {
    ...
    fn into_view(self) -> View<Message> {
        view_from_builder!(
            self,
            ViewToken::ProgressRing(ProgressRingToken {
                id: self.id,
                active: self.active,
                size: self.size,
                label: self.label,
...
impl<Message> ProgressBarBuilder<Message> {
    ...
    pub fn value(mut self, value: f32) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["value"]);
...
impl<Message> IntoView<Message> for ProgressBarBuilder<Message> {
    ...
    fn into_view(self) -> View<Message> {
        view_from_builder!(
            self,
            ViewToken::ProgressBar(ProgressBarToken {
                id: self.id,
                active: self.active,
...
impl<Message> BusyOverlayBuilder<Message> {
    ...
    pub fn opacity(mut self, opacity: f32) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["opacity"]);
    ...
    pub fn fade_transition_ms(mut self, duration_ms: u16) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["fade_transition_ms"]);
    ...
    pub fn blocks_input(mut self, blocks_input: bool) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["blocks_input"]);
...
impl<Message> IntoView<Message> for BusyOverlayBuilder<Message> {
    ...
    fn into_view(self) -> View<Message> {
        view_from_builder!(
            self,
            ViewToken::BusyOverlay(BusyOverlayToken {
                id: self.id,
                active: self.active,
...
impl<Message> CardBuilder<Message> {
    ...
    pub fn description(mut self, description: impl Into<String>) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["description"]);
    ...
    pub fn content_spacing(mut self, spacing: u16) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["content_spacing"]);
    ...
    pub fn max_height(mut self, value: u16) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["max_height"]);
    ...
    pub fn trailing(mut self, trailing: impl IntoChildren<Message>) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["trailing"]);
...
impl<Message> TextEditorBuilder<Message> {
    ...
    pub fn placeholder(mut self, value: impl Into<String>) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["placeholder"]);
    ...
    pub fn min_height(mut self, value: u16) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["min_height", "height"]);
        self.min_height = Some(value);
        self
    }
    ...
    pub fn max_height(mut self, value: u16) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["max_height", "height"]);
        self.max_height = Some(value);
        self
    }
    ...
    pub fn chrome(mut self, chrome: TextEditorChrome) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["chrome"]);
        self.chrome = chrome;
        self
    }
    ...
    pub fn secure(mut self, secure: bool) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["secure"]);
        self.secure = secure;
        self
    }
    ...
    pub fn read_only(mut self, read_only: bool) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["read_only"]);
    ...
    pub fn on_key(
        ...
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["key_bindings"]);
...
impl<Message> IntoView<Message> for TextEditorBuilder<Message> {
    ...
    fn into_view(self) -> View<Message> {
        view_from_builder!(
            self,
            ViewToken::TextEditor(TextEditorToken {
                id: self.id,
                text: self.text,
...
impl<Message> ToggleSwitchBuilder<Message> {
    ...
    pub fn header(mut self, header: impl Into<String>) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance
            .set_many(&["header", "width", "height", "labeled_height"]);
...
impl<Message> IntoView<Message> for ToggleSwitchBuilder<Message> {
    ...
    fn into_view(self) -> View<Message> {
        view_from_builder!(
            self,
            ViewToken::ToggleSwitch(ToggleSwitchToken {
                id: self.id,
                header: self.header,
                label: self.label,
...
impl<Message> RadioGroupBuilder<Message> {
    ...
    pub fn header(mut self, header: impl Into<String>) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["header"]);
        self.header = Some(header.into());
        self
    }
    ...
    pub fn option(mut self, id: impl Into<String>, label: impl Into<String>) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["options"]);
    ...
    pub fn horizontal(mut self) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["orientation"]);
    ...
    pub fn spacing(mut self, spacing: u16) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["spacing"]);
...
impl<Message> IntoView<Message> for RadioGroupBuilder<Message> {
    ...
    fn into_view(self) -> View<Message> {
        view_from_builder!(
            self,
            ViewToken::RadioGroup(RadioGroupToken {
                id: self.id,
                header: self.header,
...
impl<Message> CheckBoxBuilder<Message> {
    ...
    pub fn label_italic(mut self, italic: bool) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["label_italic"]);
    ...
    pub fn indeterminate(mut self, indeterminate: bool) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["indeterminate"]);
...
impl<Message> IntoView<Message> for CheckBoxBuilder<Message> {
    ...
    fn into_view(self) -> View<Message> {
        view_from_builder!(
            self,
            ViewToken::CheckBox(CheckBoxToken {
                id: self.id,
                label: self.label,
                checked: self.checked,
                width: self.width,
...
impl<Message> NumberBoxBuilder<Message> {
    ...
    pub fn range(mut self, min: f32, max: f32) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["min", "max", "value"]);
        self.min = Some(min);
        self.max = Some(max);
        self
    }
    ...
    pub fn min(mut self, min: f32) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["min", "value"]);
        self.min = Some(min);
        self
    }
    ...
    pub fn max(mut self, max: f32) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["max", "value"]);
        self.max = Some(max);
        self
    }
    ...
    pub fn spin_buttons(mut self, spin_buttons: bool) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["spin_buttons"]);
...
impl<Message> IntoView<Message> for NumberBoxBuilder<Message> {
    ...
    fn into_view(self) -> View<Message> {
        ...
        view_from_builder!(
            self,
            ViewToken::NumberBox(NumberBoxToken {
                id: self.id,
                value,
                min: self.min,
                max: self.max,
...
impl<Message> AutoSuggestBoxBuilder<Message> {
    ...
    pub fn suggestions(mut self, suggestions: impl IntoIterator<Item = impl Into<String>>) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["suggestions"]);
    ...
    pub fn highlighted_index(mut self, index: Option<usize>) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["highlighted_index"]);
    ...
    pub fn on_change(mut self, map: impl Fn(String) -> Message + Send + Sync + 'static) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["on_change"]);
    ...
    pub fn on_submit(
        ...
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["on_submit"]);
...
impl<Message> IntoView<Message> for AutoSuggestBoxBuilder<Message> {
    ...
    fn into_view(self) -> View<Message> {
        ...
        view_from_builder!(
            self,
            ViewToken::AutoSuggestBox(AutoSuggestBoxToken {
                id: self.id,
                text: self.text,
                placeholder: self.placeholder,
                header: self.header,
...
impl<Message> SliderBuilder<Message> {
    ...
    pub fn enabled(mut self, enabled: bool) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["state", "preview_active"]);
        self.state.enabled = enabled;
        self
    }
...
impl<Message> ComboBoxBuilder<Message> {
    ...
    pub fn label(mut self, label: impl Into<String>) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance
            .set_many(&["label", "labeled_width", "labeled_height"]);
        self.label = Some(label.into());
        self
    }
    ...
    pub fn selected(mut self, selected: impl Into<String>) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["selected", "selected_label"]);
        self.selected = Some(selected.into());
        #[cfg(feature = "parity-diagnostics")]
    ...
    pub fn width(mut self, width: Length) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["width", "labeled_width"]);
        self.width = width;
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set("width");
        self
    ...
    pub fn height(mut self, height: Length) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["height", "labeled_height"]);
        self.height = height;
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set("height");
        self
...
impl<Message> CommandBarBuilder<Message> {
    ...
    pub fn compact(mut self, compact: bool) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["compact"]);
    ...
    pub fn align(mut self, align: Alignment) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["align"]);
        self.align = align;
        self
    }
    ...
    pub fn distribution(mut self, distribution: LayoutDistribution) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["distribution"]);
...
impl<Message> IntoView<Message> for CommandBarBuilder<Message> {
    ...
    fn into_view(self) -> View<Message> {
        view_from_builder!(
            self,
            ViewToken::CommandBar(CommandBarToken {
                id: self.id,
                items: self.items,
...
impl<Message> NavigationViewBuilder<Message> {
    ...
    pub fn pane_display_mode(mut self, mode: PaneDisplayMode) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["pane_display_mode"]);
    ...
    pub fn footer_items(mut self, items: impl IntoIterator<Item = NavigationItem>) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["footer_items"]);
    ...
    pub fn settings_visible(mut self, visible: bool) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["settings_visible"]);
    ...
    pub fn back_button(mut self, message: Message) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["back_button", "back_action"]);
...
impl<Message> IntoView<Message> for NavigationViewBuilder<Message> {
    ...
    fn into_view(self) -> View<Message> {
        view_from_builder!(
            self,
            ViewToken::NavigationView(NavigationViewToken {
                id: self.id,
                selected: self.selected,
                items: self.items,
...
impl<Message> DialogBuilder<Message> {
    ...
    pub fn secondary(mut self, command: CommandToken<Message>) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["secondary"]);
...
impl<Message> LayoutBuilder<Message> {
    ...
    pub fn max_width(mut self, value: u16) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["max_width"]);
    ...
    pub fn center_x(mut self, value: bool) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["center_x"]);
        self.center_x = value;
        self
    }
...
impl<Message> GridBuilder<Message> {
    ...
    pub fn columns(mut self, columns: impl IntoIterator<Item = Length>) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["columns"]);
    ...
    pub fn row_spacing(mut self, value: u16) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["row_spacing"]);
    ...
    pub fn column_spacing(mut self, value: u16) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["column_spacing"]);
    ...
    pub fn spacing(mut self, value: u16) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["row_spacing", "column_spacing"]);
        self.row_spacing = value;
        self.column_spacing = value;
        self
    }
    ...
    pub fn cell(mut self, row: u16, column: u16, view: impl IntoView<Message>) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["children"]);
...
impl<Message> WrapBuilder<Message> {
    ...
    pub fn max_columns(mut self, value: u16) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["max_columns"]);
    ...
    pub fn run_spacing(mut self, value: u16) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["run_spacing"]);
...
impl<Message> FlyoutBuilder<Message> {
    ...
    pub fn light_dismiss(mut self, enabled: bool) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["light_dismiss"]);
    ...
    pub fn focus_behavior(mut self, behavior: FlyoutFocusBehavior) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["focus_behavior"]);
...
impl<Message> OverlayBuilder<Message> {
    ...
    pub fn layer(mut self, layer: OverlayLayer<Message>) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance
            .set_many(&["layers", "blocking_layers", "scrim_layers", "layout"]);
...
impl<Message> IntoView<Message> for OverlayBuilder<Message> {
    ...
    fn into_view(self) -> View<Message> {
        view_from_builder!(
            self,
            ViewToken::Overlay(OverlayToken {
                id: self.id,
                base: self.base,
                layers: self.layers,
                a11y: self.a11y,
...
impl<Message> AdaptiveSwitchBuilder<Message> {
    ...
    pub fn breakpoint_width(mut self, breakpoint_width: u16) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["breakpoint_width"]);
    ...
    pub fn resolved_width(mut self, resolved_width: f32) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance
            .set_many(&["resolved_width", "resolved_branch"]);
...
impl<Message> IntoView<Message> for AdaptiveSwitchBuilder<Message> {
    ...
    fn into_view(self) -> View<Message> {
        view_from_builder!(
            self,
            ViewToken::AdaptiveSwitch(AdaptiveSwitchToken {
                id: self.id,
...
impl<Message> ScrollViewBuilder<Message> {
    ...
    pub fn horizontal(mut self, policy: ScrollPolicy) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["horizontal"]);
    ...
    pub fn vertical(mut self, policy: ScrollPolicy) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["vertical"]);
    ...
    pub fn scrollbars_visible(mut self, visible: bool) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["scrollbars_visible"]);
    ...
    pub fn help_text(mut self, help_text: impl Into<String>) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["help_text"]);
...
impl<Message> IntoView<Message> for ScrollViewBuilder<Message> {
    ...
    fn into_view(self) -> View<Message> {
        view_from_builder!(
            self,
            ViewToken::ScrollView(ScrollViewToken {
                id: self.id,
                content: self.content,
...
impl<Message> PointerRegionBuilder<Message> {
    ...
    pub fn on_left_down(
        ...
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["left_down"]);
    ...
    pub fn on_left_up(
        ...
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["left_up"]);
    ...
    pub fn on_double_click(
        ...
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["double_click"]);
    ...
    pub fn on_right_down(mut self, message: Message) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["right_down"]);
    ...
    pub fn on_wheel(
        ...
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["wheel"]);
    ...
    pub fn on_escape(mut self, message: Message) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["escape"]);
...
impl<Message> IntoView<Message> for PointerRegionBuilder<Message> {
    ...
    fn into_view(self) -> View<Message> {
        view_from_builder!(
            self,
            ViewToken::PointerRegion(PointerRegionToken {
                id: self.id,
                content: self.content,
                width: self.width,
                height: self.height,
...
impl CaptureOverlayBuilder {
    ...
    pub fn detection_depth(mut self, detection_depth: usize) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["detection_depth"]);
    ...
    pub fn dragging(mut self, dragging: bool) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["dragging"]);
    ...
    pub fn detected_rect(mut self, rect: CaptureOverlayRect) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["detected_rect"]);
    ...
    pub fn selection_rect(mut self, rect: CaptureOverlayRect) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["selection_rect"]);
    ...
    pub fn handles_visible(mut self, handles_visible: bool) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["handles_visible"]);
    ...
    pub fn magnifier_visible(mut self, magnifier_visible: bool) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["magnifier_visible"]);
    ...
    pub fn background(mut self, background: CaptureOverlayBackground) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance
            .set_many(&["has_background", "background_pixels"]);
    ...
    pub fn cursor(mut self, cursor: CaptureOverlayPoint) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["cursor"]);
...
impl<Message> IntoView<Message> for CaptureOverlayBuilder {
    ...
    fn into_view(self) -> View<Message> {
        view_from_builder!(
            self,
            ViewToken::CaptureOverlay(CaptureOverlayToken {
                id: self.id,
                phase: self.phase,
...
impl<Message> IntoView<Message> for WebViewBuilder {
    ...
    fn into_view(self) -> View<Message> {
        view_from_builder!(
            self,
            ViewToken::WebView(WebViewToken {
                id: self.id,
                source: self.source,
                width: self.width,
                height: self.height,
...
impl<Message> ExpanderBuilder<Message> {
    ...
    pub fn title_id(mut self, id: impl Into<String>) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["title_id"]);
    ...
    pub fn expanded(mut self, expanded: bool) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["expanded"]);
        self.expanded = expanded;
        self
    }
    ...
    pub fn header_style(mut self, classes: impl AsRef<str>) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["header_style"]);
    ...
    pub fn content_style(mut self, classes: impl AsRef<str>) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["content_style"]);
...
impl<Message> IntoView<Message> for ExpanderBuilder<Message> {
    ...
    fn into_view(self) -> View<Message> {
        view_from_builder!(
            self,
            ViewToken::Expander(ExpanderToken {
                id: self.id,
                title: self.title,
...
impl<Message> SettingsRowBuilder<Message> {
    ...
    pub fn description_id(mut self, id: impl Into<String>) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["description_id"]);
    ...
    pub fn align_x(mut self, align_x: Alignment) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["align_x"]);
    ...
    pub fn content_align_x(mut self, align_x: Alignment) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["content_align_x"]);
    ...
    pub fn content(mut self, content: impl IntoView<Message>) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["has_content"]);
        self.content = Some(Box::new(content.into_view()));
        self
    }
...
impl<Message> IntoView<Message> for SettingsRowBuilder<Message> {
    ...
    fn into_view(self) -> View<Message> {
        view_from_builder!(
            self,
            ViewToken::SettingsRow(SettingsRowToken {
                id: self.id,
                title: self.title,
                title_id: self.title_id,
                description: self.description,
...
impl<Message> ResultCardBuilder<Message> {
    ...
    pub fn on_speak(mut self, message: Message) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["speak"]);
    ...
    pub fn on_replace(mut self, message: Message) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["replace"]);
    ...
    pub fn on_retry(mut self, message: Message) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["retry"]);
    ...
    pub fn on_toggle(mut self, map: impl Fn(String) -> Message + Send + Sync + 'static) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["toggle"]);
        self.toggle_action = Action::selection_input(map);
        self
    }
    ...
    pub fn collapse_transition(mut self, transition: CollapseTransition) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["collapse_transition_ms"]);
...
impl<Message> IntoView<Message> for ResultCardBuilder<Message> {
    ...
    fn into_view(self) -> View<Message> {
        view_from_builder!(
            self,
            ViewToken::ResultCard(ResultCardToken {
                id: self.id,
                item: self.item,
...
impl<Message> ListViewBuilder<Message> {
    ...
    pub fn virtualized(mut self, virtualized: bool) -> Self {
        #[cfg(feature = "parity-diagnostics")]
        self.provenance.set_many(&["virtualized"]);
...
impl<Message> IntoView<Message> for ListViewBuilder<Message> {
    ...
    fn into_view(self) -> View<Message> {
        view_from_builder!(
            self,
            ViewToken::ListView(ListViewToken {
                id: self.id,
                items: self.items,
                selected: self.selected,
                spacing: self.spacing,
...
impl<Message> IntoView<Message> for ResultListBuilder<Message> {
    ...
    fn into_view(self) -> View<Message> {
        view_from_builder!(
            self,
            ViewToken::ResultList(ResultListToken {
                id: self.id,
                items: self.items,
                copy_action: self.copy_action,
                speak_action: self.speak_action,
